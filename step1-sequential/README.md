...
### **3. Lire et exécuter l'implémentation optimisée dans [prog2_optimized.c](./prog2_optimized.c)**
...
(indices : [Locality and Caching](https://www.cs.utexas.edu/users/fussell/courses/cs429h/lectures/Lecture_18-429h.pdf))
...
# Scaling analysis
 ...
 A l'aide du script [scaling.sh](./scaling.sh), étudiez l'évolution de la performance des deux versions du programme pour des tailles de matrices de plus en plus grande.

 - Pour un programme donné, comment expliqué vous l'évolution du temps d'exécution en fonction de la taille des matrices. 
 ...
 `./prog2_optimized 2000`

- Quel doit être la taille des matrices pour que le calculs prennent 60 secondes environ.
